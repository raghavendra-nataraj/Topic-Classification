#!/usr/bin/env python
#
# The program runs by running topics.py. It takes input from the user about the mode i.e. training or testing along
# with a fraction. The code has to be trained at least once before testing.
# The fraction given by the user contributes to the probability of supervised or unsupervised learning.
# Each topics given in the training folder is parsed. Once the file is encountered, a coin is flipped which is biased
# on the fraction provided by the user. The coin decides whether or not the classification of that file is known or not.
